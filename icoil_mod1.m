function [icoil_total, x_control_vc, y_control_vc, ...
    equil_new]=icoil_mod1(tol, icoil_total, x_control_vc, ...
...
if control_p==1 || control_p==2 || control_p==3 || control_p==6
...
elseif control_p==4 || control_p==5
    %displ=-20;
    while dz(control_p)~=(displ/100)
        ...
        if d_z>(displ/100)  % ADJUSTABLE ACCORDING TO THE DIRECTION OF MOVT.
            [icoil_total]=v_circ(equil_new, coilset, smatrix, (-d_z/displ), control_p);
