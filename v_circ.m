function [icoil_total]=v_circ(equil, coilset, smatrix, dI, n)
% Function to calculate currents in a given coilset for MAST-U 
% where n is the respective control point, given in the smatrix
% and dI is the displacement in cm.

% This function includes test_i_limits that will report if the current in a
% given coil is beyond the operational limits.
