function [x_control, y_control]=control_points(equil);
...
%[psi_points]=interp2(psi_equil, x_mid, y_mid);
%psi_points_in=interp2(psi_equil, mid_in_r, mid_in_z);
mid_i=fiesta_point('inner_set', x_mid(1), 0);
mid_o=fiesta_point('outer_set', x_mid(2), 0);

% Modification June 22 (better intersection with the plate via connection length calculations)
%[length_3d, length_2d, conn_o_l, phi, path_3d, path_2d, seg1, seg2]=connection_length3(equil, psi_points(1), plate);
