...
figure();  % Plot all equilibria boundaries using colors
...
figure();  % Plot the current profiles at the midplane
j = get(equil_new, 'j');
j2 = get(equil_j2, 'j');
j3 = get(equil_j3, 'j');
j4 = get(equil_j4, 'j');
...
figure();  % Plot the current profiles from psi_zero
plot(psi_j, j_prof, 'k')
hold on
...
figure();  % Plot changes in internal inductance and poloidal beta
...
figure();  % Plot evolution of coefficients (ALPHA)
...
figure();  % Plot evolution of coefficients (BETA)
...
figure();  % Coil currents as Li changes (02/08 modif)
...
Lo_SXD400kA_d1_allfree = sortrows([Li;d1]', 1)';
Lo_SXD400kA_d2_allfree = sortrows([Li;d2]', 1)';
Lo_SXD400kA_d3_allfree = sortrows([Li;d3]', 1)';
Lo_SXD400kA_dp_allfree = sortrows([Li;dp]', 1)';
Lo_SXD400kA_d5_allfree = sortrows([Li;d5]', 1)';
Lo_SXD400kA_d6_allfree = sortrows([Li;d6]', 1)';
Lo_SXD400kA_d7_allfree = sortrows([Li;d7]', 1)';
Lo_SXD400kA_p4_allfree = sortrows([Li;p4]', 1)';

figure();
plot(Lo_SXD400kA_d1_allfree(1, :), Lo_SXD400kA_d1_allfree(2, :), '-')
hold on
plot(Lo_SXD400kA_d1(1, :), Lo_SXD400kA_d1(2, :), '--')
plot(Lo_SXD400kA_d2_allfree(1, :), Lo_SXD400kA_d2_allfree(2, :), 'r-')
plot(Lo_SXD400kA_d2(1, :), Lo_SXD400kA_d2(2, :), 'r--')
plot(Lo_SXD400kA_d3_allfree(1, :), Lo_SXD400kA_d3_allfree(2, :), 'g-')
plot(Lo_SXD400kA_d3(1, :), Lo_SXD400kA_d3(2, :), 'g--')
plot(Lo_SXD400kA_dp_allfree(1, :), Lo_SXD400kA_dp_allfree(2, :), 'm-')
plot(Lo_SXD400kA_dp(1, :), Lo_SXD400kA_dp(2, :), 'm--')
legend('d1 all-free', 'd1', 'd2 all-free', 'd2', 'd3 all-free', 'd3', 'dp all-free', 'dp fixed')

figure();
plot(Lo_SXD1MA_d5_allfree(1, :), Lo_SXD1MA_d5_allfree(2, :), '-')
hold on
plot(Lo_SXD1MA_d5(1, :), Lo_SXD1MA_d5(2, :), '--')
plot(Lo_SXD1MA_d6_allfree(1, :), Lo_SXD1MA_d6_allfree(2, :), 'r-')
plot(Lo_SXD1MA_d6(1, :), Lo_SXD1MA_d6(2, :), 'r--')
plot(Lo_SXD1MA_d7_allfree(1, :), Lo_SXD1MA_d7_allfree(2, :), 'g-')
plot(Lo_SXD1MA_d7(1, :), Lo_SXD1MA_d7(2, :), 'g--')
plot(Lo_SXD1MA_p4_allfree(1, :), Lo_SXD1MA_p4_allfree(2, :), 'm-')
plot(Lo_SXD1MA_p4(1, :), Lo_SXD1MA_p4(2, :), 'm--')
legend('d5 all-free', 'd5', 'd6 all-free', 'd6', 'd7 all-free', 'd7', 'p4 all-free', 'p4')
