...
%mid_i=fiesta_point('in_midplane', x_mid(1)-0.000046, 0);
mid_o=fiesta_point('out_midplane', x_mid(2)+0.00104, 0);
mid_ox=fiesta_point('out_midplane', x_mid(2)+0.01, 0);
...
%[len_3d_il, length_2d, conn_i_l, phi, path_3d, path_2d]=connection_length2(equil, mid_i, plate);
